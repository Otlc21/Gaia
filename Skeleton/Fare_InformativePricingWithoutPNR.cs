...
namespace Skeleton
{
    public class Fare_InformativePricingWithoutPNR
    {
        public string _xml = $@"
         ...
         <segmentGroup>
            <segmentInformation>
               <flightDate>
                  ...
                  <departureTime>${{Transfered Properties#S01_L01_departure_time}}</departureTime>
               </flightDate>
               <boardPointDetails>
         ...
         <segmentGroup>
            <segmentInformation>
               <flightDate>
                  ...
                  <departureTime>${{Transfered Properties#S02_L01_departure_time}}</departureTime>
               </flightDate>
               <boardPointDetails>
...
";
        public string _service = "TIPNRQ_24_3_1A";
