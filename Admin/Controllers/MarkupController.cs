...
namespace Admin.Controllers
{
    ...
    public class MarkupController : Controller
    {
        ...
        private readonly IMarkupServico _servico;
        public MarkupController(IMarkupServico servico)
        {
            _servico = servico;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Insert([FromBody] MarkupViewModel item)
        {
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            return View(new MarkupViewModel(item));
        }

        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] MarkupViewModel item)
        {
