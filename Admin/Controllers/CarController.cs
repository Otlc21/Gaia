...
namespace Admin.Controllers
{
    ...
    public class CarController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get(CarViewModel item)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Insert([FromBody] CarViewModel item)
        {
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            return View(new CarViewModel(item));
        }

        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] CarViewModel item)
        {
