...
namespace Admin.Controllers
{
    ...
    public class AirlineController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Get(AirlineViewModel item)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Insert([FromBody] AirlineViewModel item)
        {
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            return View(new AirlineViewModel(item));
        }

        [HttpPut("{id}")]
        public async Task<IActionResult> Update(int id, [FromBody] AirlineViewModel item)
        {
